...
public class CollegeApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfLmuId = new javax.swing.JTextField();
        ...
        pnlForm.setBackground(new java.awt.Color(234, 192, 32));
        pnlForm.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Student Data Form", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.ABOVE_TOP));

        tfLmuId.setBackground(new java.awt.Color(234, 192, 32));
        tfLmuId.setBorder(javax.swing.BorderFactory.createTitledBorder("lMU Id"));
        tfLmuId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfLmuIdActionPerformed(evt);
            }
        });

        tfFullName.setBackground(new java.awt.Color(234, 192, 32));
        ...
        tfProgram.setBackground(new java.awt.Color(234, 192, 32));
        tfProgram.setBorder(javax.swing.BorderFactory.createTitledBorder("Program"));

        tfContact.setBackground(new java.awt.Color(234, 192, 32));
        tfContact.setBorder(javax.swing.BorderFactory.createTitledBorder("Contact"));
        ...
        tfAge.setBackground(new java.awt.Color(234, 192, 32));
        ...
        pnlFormLayout.setHorizontalGroup(
            ...
            .addGroup(pnlFormLayout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(tfLmuId, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(tfFullName, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(tfProgram, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(tfContact, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                    ...
                    .addGroup(pnlFormLayout.createSequentialGroup()
                        .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(tfLmuId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(tfAge)
                            .addComponent(addStudentBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        pnlStudentListLayout.setHorizontalGroup(
            ...
            .addGroup(pnlStudentListLayout.createSequentialGroup()
                ...
                .addGroup(pnlStudentListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(spTblStudent, javax.swing.GroupLayout.DEFAULT_SIZE, 1031, Short.MAX_VALUE)
        ...
        pnlStudentListLayout.setVerticalGroup(
            ...
            .addGroup(pnlStudentListLayout.createSequentialGroup()
                ...
                .addComponent(spTblStudent, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(42, 42, 42)
...
// Method to set up the CardLayout and add panels
    ...
    private void initializeLayout() {
       ...
       private void registerStudent(StudentModel student) {
        ...
        model.addRow(new Object[]{student.getLmuId(), student.getName(), student.getProgram(),student.getContact(), student.getAge()
        });
    }
    ...
    private void tfLmuIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfLmuIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfLmuIdActionPerformed
    ...
    String lmuIdText = tfLmuId.getText().trim;
    String program = tfProgram.getText().trim();
    String contact = tfContact.getText().trim();
    String ageText = tfAge.getText().trim();
    
    if (ValidationUtil.isNullOrEmpty(ageText) || ValidationUtil.isNullOrEmpty(fullName) || ValidationUtil.isNullOrEmpty(lmuIdText) || ValidationUtil.isNullOrEmpty(program) || ValidationUtil.isNullOrEmpty(contact)) {
        JOptionPane.showMessageDialog(this, "Fields cannot be empty!","Warning", JOptionPane.WARNING_MESSAGE); 
    }
    
    else{
        try{
            int lmuId = Integer.parseInt(lmuIdText);
     ...
     if(ValidationUtil.isValidAge(age) && ValidationUtil.isValidLmuId(lmuId) ){
            JOptionPane.showMessageDialog(
            null,                               // Parent component (null means center of the screen)
            "Plz make sure you have entered valid age or lmuId !",         // Message to display
    ...
    try {
        ...
        StudentModel model = new StudentModel(lmuId, fullName, program, contact, (short) age);
        ...
        JOptionPane.showMessageDialog(
            null, 
            "LMU ID and Age must be valid numbers!", 
            "Error", 
    ...
    private javax.swing.JTextField tfLmuId;
